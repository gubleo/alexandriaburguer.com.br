...
<head>
	...
	<script>(function (w, d, s, l, i) {
		...
		})(window, document, 'script', 'dataLayer', 'GTM-55K8XXT7');</script>
...
<body>
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-55K8XXT7" height="0" width="0"
			style="display:none;visibility:hidden"></iframe></noscript>
	<!-- End Google Tag Manager, BL COMPANY (noscript) -->
			...
			<div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
				<div class="formulario" id="formulario">
					...
					<form id="form" name="formulario" class="form" action="" method="post">
						<div class="campos">
							<input type="hidden" class="data" name="DATA" value="<?php echo date('d/m/y'); ?> às <?php echo date('H:i'); ?>" />
							<input type="hidden" class="utmsource" name="UTM Source" value="" />
							<input type="hidden" class="utmmedium" name="UTM Medium" value="" />
							<input type="hidden" class="utmcampaign" name="UTM Term" value="" />
							<input type="hidden" class="utmcontent" name="UTM Content" value="" />
							<input type="hidden" class="utmcampaing" name="UTM Campaing" value="" />
                            ...
                            <div class="col-12">
                                <label for="CAPITAL" class="form-label">O Capital de Investimento é a partir de R$249 mil:</label>
								<select class="form-control" id="CAPITAL" name="CAPITAL" required>
									...
									<option value="De R$249 mil a R$300 mil">Tenho de R$249 mil a R$300 mil para investir</option>
									<option value="De R$300 mil a R$350 mil">Tenho de R$300 mil a R$350 mil para investir</option>
				...
				<div class="item">
					<div class="row">
						...
						<div class="col-lg-7 col-md-7 col-sm-8 col-xs-12">
							<div class="pt03">
								<p>
									Hamburguerias representam pouco mais de 50% do faturamento das redes de fast-food – estimado em mais de R$ 22 bilhões em 2014.
								</p>
							</div>
						</div>
					</div>
	...
	<footer class="footer">
		©<span id="ano"></span> AlexandriA Burger - Todos os direitos reservados.
	</footer>
	
	<script type="text/javascript" async src="https://d335luupugsy2.cloudfront.net/js/loader-scripts/6b8ac248-fc00-40d4-aa8b-8f30bbef298a-loader.js" ></script>
    ...
    <script type="text/javascript">
        ...
        const utm_campaing = urlParams.get('utm_campaign');

        (function($) {
            "use strict";

            $(document).ready(function() {
                $("input[name='UTM Source']").val(utm_source);
                $("input[name='UTM Medium']").val(utm_medium);
                $("input[name='UTM Term']").val(utm_term);
                $("input[name='UTM Content']").val(utm_content);
                $("input[name='UTM Campaing']").val(utm_campaing);
            });
        }
        )(jQuery);
    </script>
