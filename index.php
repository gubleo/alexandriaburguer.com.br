...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-55K8XXT7" height="0" width="0"
...
<section class="banner">
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
            ...
            <div class="chamada">
                <h1>Empreenda com a primeira<br/>franquia de rodízio</h1>
                    ...
                    <div class="item">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 d-flex align-items-center">
                                <div class="texto">
                                    <p>
                                        Modelo de negócio <br>testado e aprovado <br>em mais de 30 cidades
                                    </p>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript" async
        src="https://d335luupugsy2.cloudfront.net/js/loader-scripts/6b8ac248-fc00-40d4-aa8b-8f30bbef298a-loader.js"></script>
